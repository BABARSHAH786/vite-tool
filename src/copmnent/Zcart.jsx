//working original code without search
// "use client";
...
//   return (
//     <section key={post._id || post.productName} className="ml-2 w-[410px] flex flex-col ...">
//       {" "}
//       {/* ... rest of your JSX */}
//       <Image
...
//       {/* add to cart work */}
//             <button
//                     className="p-3 border rounded bg-red-600 w-[234px]   "
...
//   return (
//     <section key={post._id} className="ml-2 w-[410px] flex flex-col">
//       <Image
//         src={urlForImage(post.image)}
